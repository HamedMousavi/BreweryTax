...
namespace ApplicationUpdater
{
    ...
    public class ServiceIo
    {
        ...
        public static void SaveSettings()
        {
            ...
            try
            {
                string path = Application.StartupPath + Path.DirectorySeparatorChar + Settings.Instance.DirectoryName;
        ...
        internal static bool OverwriteDownloadedFiles()
        {
            ...
            string dst = Application.StartupPath;
        ...
        internal static bool BackupStartupDirectory()
        {
            try
            {
                ...
                string zipFile = Application.StartupPath + Path.DirectorySeparatorChar + "Backup.zip";
                ...
                using (ZipFile zip = new ZipFile())
                {
                    ...
                    foreach (string file in items)
                    {
                        string path = file.Replace(updaterDir, Application.StartupPath);
                        if (File.Exists(path))
                        {
                            zip.AddFile(path, "");
                        }
        ...
        internal static string GetUpdateAppProcessName()
        {
            string procName = Settings.Instance.UpdateApplicationName;
        ...
        internal static string GetUpdateAppPath()
        {
            return 
                Application.StartupPath + 
                Path.DirectorySeparatorChar + 
